...
//  GtkWidget *vbox16 = glade_xml_get_widget(interface, "vbox16");
  ...
  GtkWidget *label65 = glade_xml_get_widget(interface, "label65");
  GtkWidget *label67 = glade_xml_get_widget(interface, "label67");
  GtkWidget *label68 = glade_xml_get_widget(interface, "label68");
  GtkWidget *label69 = glade_xml_get_widget(interface, "label69");
  GtkWidget *label70 = glade_xml_get_widget(interface, "label70");
  GtkWidget *label45 = glade_xml_get_widget(interface, "label45");
  GtkWidget *label66 = glade_xml_get_widget(interface, "label66");
  GtkWidget *hbox5 = glade_xml_get_widget(interface, "hbox5");
  GtkWidget *button15 = glade_xml_get_widget(interface, "button15");
  GtkWidget *button8 = glade_xml_get_widget(interface, "button8");
  GtkWidget *label47 = glade_xml_get_widget(interface, "label47");
  GtkWidget *frame2 = glade_xml_get_widget(interface, "frame2");
  GtkWidget *alignment2 = glade_xml_get_widget(interface, "alignment2");
  GtkWidget *table4 = glade_xml_get_widget(interface, "table4");
  GtkWidget *label41 = glade_xml_get_widget(interface, "label41");
  GtkWidget *label32 = glade_xml_get_widget(interface, "label32");
  GtkWidget *label38 = glade_xml_get_widget(interface, "label38");
  GtkWidget *label33 = glade_xml_get_widget(interface, "label33");
  GtkWidget *label39 = glade_xml_get_widget(interface, "label39");
  GtkWidget *label36 = glade_xml_get_widget(interface, "label36");
  GtkWidget *label42 = glade_xml_get_widget(interface, "label42");
  GtkWidget *label35 = glade_xml_get_widget(interface, "label35");
  GtkWidget *label30 = glade_xml_get_widget(interface, "label30");
  GtkWidget *label31 = glade_xml_get_widget(interface, "label31");
...
//  GtkWidget *hbox22 = glade_xml_get_widget(interface, "hbox22");
  ...
  GtkWidget *radiobutton16 = glade_xml_get_widget(interface, "radiobutton16");
  GtkWidget *label115 = glade_xml_get_widget(interface, "label115");
  GtkWidget *hbox23 = glade_xml_get_widget(interface, "hbox23");
...
//  GtkWidget *vbox22 = glade_xml_get_widget(interface, "vbox22");
  ...
  GtkWidget *label22 = glade_xml_get_widget(interface, "label22");
  GtkWidget *entry3 = glade_xml_get_widget(interface, "entry3");
  GtkWidget *label23 = glade_xml_get_widget(interface, "label23");
...
//---------label for grid
  label_grid_v[0] = glade_xml_get_widget(interface, "label15");
  label_grid_v[2] = glade_xml_get_widget(interface, "label16");
  label_grid_v[4] = glade_xml_get_widget(interface, "label17");
  label_grid_v[6] = glade_xml_get_widget(interface, "label18");

  label_grid_h[0][0] = glade_xml_get_widget(interface, "label7");
  label_grid_h[0][2] = glade_xml_get_widget(interface, "label8");
  label_grid_h[0][4] = glade_xml_get_widget(interface, "label9");
  label_grid_h[0][6] = glade_xml_get_widget(interface, "label10");

  label_grid_h[1][0] = glade_xml_get_widget(interface, "label11");
  label_grid_h[1][2] = glade_xml_get_widget(interface, "label12");
  label_grid_h[1][4] = glade_xml_get_widget(interface, "label13");
  label_grid_h[1][6] = glade_xml_get_widget(interface, "label14");
//---------label for grid
...
//------------------Traffic callbacks-------------		    
  ...
  g_signal_connect ((gpointer) checkbutton_trf_auto, "toggled",
                    ...
                    NULL);
  g_signal_connect ((gpointer) combobox_trf_repo, "changed",
